(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else root["NumericInput"] = factory(root["React"], root["PropTypes"]);
})(
  this,
  function (__WEBPACK_EXTERNAL_MODULE_1__, __WEBPACK_EXTERNAL_MODULE_2__) {
      ...
      /******/ [
        ...
        /***/ function (module, exports, __webpack_require__) {
          ...
          function addClass(element, className) {
            ...
            if (
              !element.className.search(new RegExp("\\b" + className + "\\b"))
            ) {
          ...
          var NumericInput = (function (_Component) {
            ...
            function NumericInput() {
              ...
              var _this = _possibleConstructorReturn(
                this,
                (_ref =
                  NumericInput.__proto__ ||
                  Object.getPrototypeOf(NumericInput)).call.apply(
                  _ref,
                  [this].concat(args)
                )
              );
            ...
            _createClass(NumericInput, [
              {
                ...
                value: function _propsToState(props) {
                  ...
                  if (props.hasOwnProperty("value")) {
                    ...
                    out.value =
                      out.stringValue !== "" ? this._parse(props.value) : null;
                  } else if (
                    !this._isMounted &&
              ...
              },
              {
                ...
                value: function _onKeyDown() {
                  ...
                  args[0].persist();
                  this._invokeEventCallback.apply(
                    this,
                    ["onKeyDown"].concat(args)
                  );
                  var e = args[0];
                  if (!e.isDefaultPrevented()) {
                    if (e.keyCode === KEYCODE_UP) {
                      e.preventDefault();
                      this._step(
                        e.ctrlKey || e.metaKey ? 0.1 : e.shiftKey ? 10 : 1
                      );
                      ...
                      if (e.keyCode === 8) {
                        ...
                        if (
                          ...
                          _value.length &&
                          _value.charAt(this.refsInput.selectionEnd - 1) === "."
                        ) {
                          e.preventDefault();
                          this.refsInput.selectionStart =
                            this.refsInput.selectionEnd =
                        ...
                        if (
                          ...
                          _value.length &&
                          _value.charAt(this.refsInput.selectionEnd) === "."
                        ) {
                          e.preventDefault();
                          this.refsInput.selectionStart =
                            this.refsInput.selectionEnd =
              ...
              },
              {
                ...
                value: function _invokeEventCallback(callbackName) {
                  if (typeof this.props[callbackName] == "function") {
                    ...
                    (_props$callbackName = this.props[callbackName]).call.apply(
                      _props$callbackName,
                      [null].concat(args)
                    );
                  }
                    ...
                    _extends(attrs.btnUp, {
                      ...
                      onMouseDown: function onMouseDown() {
                        ...
                        _this6.setState(
                          ...
                          function () {
                            _this6._invokeEventCallback.apply(
                              _this6,
                              ["onFocus"].concat(args)
                            );
          ...
          NumericInput.propTypes = {
            ...
            precision: _propTypes2.default.oneOfType([
              _propTypes2.default.number,
              _propTypes2.default.func,
            ]),
            ...
            noValidate: _propTypes2.default.oneOfType([
